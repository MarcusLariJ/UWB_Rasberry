...
//#define APP_TWR_PDOA      // TWR tag with full data collection (double antenna module) => used for final measurements
//#define APP_TWR_ANCHOR    // TWR anchor (single antenna module) => used for final measurements
