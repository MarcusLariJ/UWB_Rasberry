...
#ifdef APP_TWR_PDOA
    extern int application_twr_pdoa_tag(void);

    example_pointer=application_twr_pdoa_tag;
    test_cnt++;
#endif

#ifdef APP_TWR_ANCHOR
    extern int application_twr_anchor(void);

    example_pointer=application_twr_anchor;
    test_cnt++;
#endif
