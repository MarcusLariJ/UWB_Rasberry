...
static const uint64_t min_tx_timeout = 13000; // (13 ms) min timout value (us) - the minimum time a node at least has to attempt being an anchor. Should be larger than responses timeout to avoid two tags
