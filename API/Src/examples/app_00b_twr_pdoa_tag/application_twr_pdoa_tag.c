...
#define TX_ANT_DLY (16385-50)
#define RX_ANT_DLY (16385-50)
	...
	while (1)
	{
		...
		case TWR_POLL_RESPONSE_STATE_ANC:
			...
			if ((tx_done == 2) && (rx_done == 2)) {
				...
				tx_timestamp_final = (((rx_timestamp_response + round_tx_delay + TX_ANT_DLY) >> 9) << 9);
